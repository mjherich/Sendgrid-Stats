...
class Frontend
{
    ...
    public function assets() {
        wp_enqueue_style($this->plugin_slug, plugin_dir_url(__FILE__).'css/sendgrid-stats-frontend.css', [], $this->version);
        wp_enqueue_script($this->plugin_slug, plugin_dir_url(__FILE__).'js/sendgrid-stats-frontend.js', ['jquery'], $this->version, true);
    }
