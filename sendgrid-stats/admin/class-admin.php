...
class Admin
{
    ...
    private function custom_settings_fields($field_args, $settings) {
        ...
        foreach ($field_args as $field) {
            ...
            $label = esc_attr__($field['label'], 'sendgrid-stats');
    ...
    public function assets() {
        wp_enqueue_style($this->plugin_slug, plugin_dir_url(__FILE__).'css/sendgrid-stats-admin.css', [], $this->version);
        wp_enqueue_script($this->plugin_slug, plugin_dir_url(__FILE__).'js/sendgrid-stats-admin.js', ['jquery'], $this->version, true);
    }
    ...
    public function render() {
        ...
        $submit_text = esc_attr__('Submit', 'sendgrid-stats');
